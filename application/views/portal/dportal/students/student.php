...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="<?=site_url('/dportal');?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a  class="current" href="#">Students</a></div>
    <h1>Student Accounts</h1>
  </div>
  <div class="container-fluid"><hr>
      <div class="row-fluid">
        <div class="widget-content"  style="margin-left: 1rem;">
            <a type="button"  style="margin-left:-2rem; " class="btn btn-success" href="<?=site_url('dportal/students/add')?>">Add Student</a>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('Portal_DO/ajax_listStudents')?>",
            "type": "POST"
        },
...
function delete_person(id)
{
    ...
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('Portal_DO/ajax_delete_student')?>/"+id,
            type: "POST",
            dataType: "JSON",
