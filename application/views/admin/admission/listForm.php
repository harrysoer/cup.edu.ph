            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">Forms Data</h4>
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="m-b-30">
                                            <a href="<?=site_url('admin/admission/forms/upload')?>"><button id="addToTable"  class="btn btn-success waves-effect waves-light">Add <i class="fa fa-plus"></i></button></a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <table class="table table-bordered table-striped" id="table">
                                    <thead>
                                        <tr>
                                            <th>File</th>
                                            <th style="width:125px;">File Description</th>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('admin/admission/forms/callList')?>",
            "type": "POST"
        },
