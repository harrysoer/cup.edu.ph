 ...
 <body>
      ...
      <div class="menu_area">
        <nav class="navbar  navbar-default navbar-fixed-top" role="navigation">  <div class="container">
            <div class="navbar-header">
              ...
              <!-- LOGO -->
              <a href="<?=site_url('/index');?>" class="navbar-brand hidden-xs"><img src="<?=base_url('assets/for_main/img/logo1.png');?>" style="margin-top: -5px; margin-left: 133px;" alt="logo"></a>            
   ...
   <section id="courseArchive">
              ...
              <div class="single_sidebar">
                <ul class="news_tab">
                  ...
                  <li>
                    <div class="media">
                      <div class="media-body">
                       <a href="<?=site_url('/adm');?>" style="color: #fdcd3d;"  ><span class="glyphicon glyphicon-user fa-lg" style="padding-right: 13px;"></span>Administrators</a>
                      </div>
                    </div>
                  </li>
                  <li>
              ...
              <div class="row">
                ...
                <div class="col-lg-12 col-12 col-sm-12">
                  <div class="single_blog">
                    <h2 class="blog_title">Executive Authorities</h2>
                    <br>
    ...
    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
        ...
        <br>
        <h2 class="blog_title">Administrative Offices</h2>
        <br>
