...
<html lang="">
	...
	<div class="container-fluid">
		...
		<a type="button" href="<?=site_url('admin/portal/school_year/add')?>" class="btn btn-info">Add <span class="glyphicon glyphicon-plus" ></span></a>
		...
		<table class="table table-bordered 	">
			...
			<tbody>
			<?php if ($get_school_year	!= null	): ?>
				
			<?php foreach ($get_school_year as $school_year): ?>
				<tr>
					<td><?=$school_year['last_name']?></td>
					<td><?=$school_year['first_name']?></td>
					<td><?=$school_year['mi']?></td>
					<td><?=$school_year['course']?></td>
					
					<td>
						<a type="button"  class="btn btn-info">Edit <span class="glyphicon glyphicon-pencil" ></span></a>
						<a type="button"  class="btn btn-danger">Delete <span class="glyphicon glyphicon-trash" ></span></a>
					</td>
				</tr>
			<?php endforeach ?>
			<?php else: ?>
