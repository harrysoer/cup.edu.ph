...
class Portal_Prof_login extends CI_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->load->model('Ion_auth_model');
		$this->load->model('portal_Prof_m', 'faculty');
		$this->lang->load('auth');
	...
	{
		$data['name'] = "Faculty";
		$this->load->view('portal/f-other_login', $data);	
	}
